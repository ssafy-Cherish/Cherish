			...
			<div className="h-14 bg-pink rounded-b-2xl">
				{!meetingInfo.isModalOpen && (
					<div className="w-full h-full flex flex-row justify-between">
						<div className="border-2 m-2 w-1/3 flex flex-row">
							<div className="w-[15%] h-full border-2">
								...
								>
									...
									{meetingInfo.video.local.volume == 0 && <img className="w-full h-full absolute" src={barImg}></img>}
								</button>
							</div>
							<div className="w-[15%] h-full border-2">
								<button
								...
								>
									...
									{!meetingInfo.video.local.videoOn && <img className="w-full h-full absolute" src={barImg}></img>}
								</button>
							</div>
							<div
						...
						<button
							className="border-2 m-2 w-14 rounded-2xl btn"
