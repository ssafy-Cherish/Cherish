  ...
  return (
    <div className="mt-[4vw]">
      ...
      <div id='LinkCradWrapper' className="mt-5 h-[17vw] grid grid-cols-9 gap-5">
        <div id='Pot' className="bg-pink col-span-3 grid grid-cols-5 rounded-[20px] shadow-md">
          <div id='PotState' className="col-span-2 flex flex-col items-center">
            <div id='PotImg'>
              <img src={PotLv1} alt="PotImg" />
            </div>
            <p id='PotName'className="text-[1.2vw] text-cherry">체리 떡잎</p>
            <progress id="PotExp" className="PotExp h-2 w-[7vw] mt-5" max="100" value="70" />
          </div>
          <div id='PotDescrption' className="col-span-3 flex flex-col items-center justify-around">
            <p id='PotCouple' className="text-[1.5vw]">알콩달콩 <span className="text-cherry">커플</span></p>
            ...
            <button id='GoPot' className="text-[1.2vw]">경험치 기록 보기</button>
          </div>
        </div>
        <div id='Diary' className="bg-skyblue col-span-2  flex flex-col items-center rounded-[20px] shadow-md">
          <div className="mt-[1vw]"><img src={DiaryImg} alt="DiaryImg" /></div>
          <p className="mt-[1vw] text-[1.2vw]">다이어리</p>
          </div>
        <div id='CherryCall' className="bg-beige col-span-2 flex flex-col items-center justify-around rounded-[20px] shadow-md">
          <p className="text-[1.2vw] mt-[1vw]"><span className="text-cherry">체리콜</span>로 화분을 키워요!</p>
          <div><img src={CoupleImg1} alt="CoupleImg1" /></div>
          <p className="text-[1.2vw] mb-[1.8vw]">체리콜</p></div>
